...
abstract class CLEndpoints
{
    ...
    const string ORDERS_BY_LAST = "/v3/merchants/{MERCHANT_ID}/orders?expand=employee&expand=lineItems&expand=payments&expand=payments.cardTransaction&expand=customers&expand=voids&expand=payments.employee&limit=200&forceRealTime=true:get";
